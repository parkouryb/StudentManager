...
public class ManagerForm extends JFrame implements ActionListener{
	...
	private void initComponents() {
		...
		//---- button1 ----
		button1.setText("Add New Manager");
		...
		//---- label1 ----
		label1.setText("Student's Manager");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(btnButton.equals(button1)) {
			AddManagerForm addmgForm = new AddManagerForm();
			addmgForm.setVisible(true);
		}
		else if (btnButton.equals(button2)) {
			SearchManagerForm srcForm = new SearchManagerForm();
			srcForm.setVisible(true);
		}
	}
	
	// JFormDesigner - Variables declaration - DO NOT MODIFY  //GEN-BEGIN:variables
	// Generated using JFormDesigner Evaluation license - Nhung
	private JButton button1;	//add manager
	private JButton button2;	//search manager
