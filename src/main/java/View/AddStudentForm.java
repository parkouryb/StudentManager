...
public class AddStudentForm extends JFrame implements ActionListener {
	...
	public void apply1Action() throws Exception {
		...
		else if(stdIT.dayEx(birthdayTF.getText()) == false) {
			showMess("Wrong birhtday format!");
		}
	...
	public void apply2Action() throws Exception {
		...
		else if(studentIT.dayEx(dayinTF.getText()) == false ||
				studentIT.dayEx(dayoutTF.getText()) == false ) {
			showMess("Wrong date format!");
		}
		else {
